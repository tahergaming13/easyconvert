  ...
  el.innerHTML = `
    ...
    <div class="mt-6 grid gap-6 lg:grid-cols-[1fr_320px]">
      ...
      <div class="h-fit rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-700 dark:bg-slate-900">
        ...
        <button id="go" class="mt-4 w-full rounded-xl bg-gradient-to-r from-slate-600 to-slate-800 px-4 py-3 text-sm font-bold text-white shadow-lg disabled:opacity-40">Extract text <i class="ph ph-lightning text-base" aria-hidden="true"></i></button>
